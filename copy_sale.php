...
<script>
    ...
    $('#prod-list .prod-item').click(function() {
        ...
        tr.append('<td><input type="hidden" name="id[]" id="" value=""><input type="hidden" name="id[]" id="" value="' + data.id + '">' + data.pro_name + ' <small class="psmall">(' + (parseFloat(data.price).toLocaleString("en-US", {
            style: 'decimal',
